...
class core:
    def __init__(self, file_1, file_2):
        ...
        self.structure_1 = Structure.from_file(file_1, primitive=False, sort=False, merge_tol=0.0)
        self.structure_2 = Structure.from_file(file_2, primitive=False, sort=False, merge_tol=0.0)
    ...
    def search_one_position(self, axis, theta, theta_range, dtheta, two_D = False):
        ...
        for i in x:
            ...
            print(f"rotation matrix = {rot(axis, theta)}")
